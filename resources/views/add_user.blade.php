        ...
        <div class="card p-4">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col">
                        <h2 style="font-family: 'Concert One', cursive;">Add New User</h2>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <form action="{{ Route('add.user') }}" method="post">
                    ...
                    <div class="row mb-4">
                      <div class="col">
                        <div class="form-outline">
                          <input type="text" name="name" value="{{ old('name') }}" id="form3Example1" class="form-control" />
                      ...
                      <div class="col">
                        <div class="form-outline">
                          <input type="text" name="email" value="{{ old('email') }}" id="form3Example2" class="form-control" />
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col">
                          <div class="form-outline">
                            <input type="text" name="password" id="form3Example2" class="form-control" />
